...
namespace MotionDataHandler.Script.Parse {
    ...
    struct FixedList<T1, T2, T3> {
        public T1 Element1;
        public T2 Element2;
        public T3 Element3;
        public FixedList(T1 element1, T2 element2, T3 element3) {
            this.Element1 = element1;
            this.Element2 = element2;
    ...
    struct FixedList<T1, T2, T3, T4> {
        public T1 Element1;
        public T2 Element2;
        public T3 Element3;
        public T4 Element4;
        public FixedList(T1 element1, T2 element2, T3 element3, T4 element4) {
            this.Element1 = element1;
            this.Element2 = element2;
            this.Element3 = element3;
        ...
        public override string ToString() {
            return string.Format("1: <{0}>, 2: <{1}>, 3: <{2}>, 4: <{3}>", this.Element1, this.Element2, this.Element3, this.Element4);
        }
    }
    ...
    struct Selection<T1, T2, T3> {
        public readonly Optional<T1> Element1;
        public readonly Optional<T2> Element2;
        public readonly Optional<T3> Element3;
        public Selection(T1 element) {
            this.Element1 = element;
            this.Element2 = Optional<T2>.Empty;
            this.Element3 = Optional<T3>.Empty;
        }
        public Selection(T2 element) {
            this.Element1 = Optional<T1>.Empty;
            this.Element2 = element;
        ...
        public override string ToString() {
            ...
            if(this.Element3.HasValue) {
                return string.Format("3: {0}", this.Element3.Value);
            }
            return "null: null";
        }
    }
